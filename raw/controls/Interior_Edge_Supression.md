...
**Interior Edge Suppression** allows you to suppress the interior edges of the scoped parts, zones or labels.

**Interior Edge Suppression Details** view has the following options:
