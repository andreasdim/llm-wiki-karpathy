...
**Thin Face Removal** removes the thin faces by merging them with the neighboring faces below the specified tolerance.

**Thin Face Removal** **Details** view has the following options:
