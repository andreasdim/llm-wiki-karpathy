...
**Deletion** control allows you to delete the scoped entities in the workflow.

![](../resources/Stacker_Delete_Base_Face.png)

**Deletion** control Details view has the following options:
