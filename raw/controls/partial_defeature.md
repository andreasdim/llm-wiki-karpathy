...
**Partial Defeature** **Details** view has the following options:
...
* **Thin Face Width** : Allows you to specify the width of the thin face. The default value for **Thin Face Width** is **0.0 mm**.
