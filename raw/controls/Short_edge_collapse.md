...
**Short Edge Collapse** allows you to collapse the edges below the defined Short Edge Length. Feature edges and Protected edges are not collapsed.

**Short Edge Collapse Details** view has the following options:
...
* **Short Edge Length**: Allows you to specify the shortest edge length to perform short edge collapse control.
  You can click ![forward](../resources/publish.png) on the right corner of the option and click **Publish** to publish **Short Edge Length** to the **Property Worksheet**.
  You can parametrize **Short Edge Length**.